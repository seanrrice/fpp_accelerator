...
#define AUTOTB_TVOUT_imStack "../tv/cdatafile/c.equalStep_baseline.autotvout_imStack.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_wrappedPhase "../tv/rtldatafile/rtl.equalStep_baseline.autotvout_wrappedPhase.dat"
#define AUTOTB_TVOUT_PC_mod_r "../tv/rtldatafile/rtl.equalStep_baseline.autotvout_mod_r.dat"
...
extern "C"
void equalStep_baseline_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_equalStep_baseline_hw(void* __xlx_apatb_param_imStack, void* __xlx_apatb_param_wrappedPhase, void* __xlx_apatb_param_mod_r)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_imStack),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_imStack),
#endif
#endif
    .hasWrite = { false },
    .max_nbytes = { 0 },
  };
  port0.param = { __xlx_apatb_param_imStack };
  port0.mname = { "imStack" };
  port0.nbytes = { 40960 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_wrappedPhase),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_wrappedPhase),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_wrappedPhase),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_wrappedPhase),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_wrappedPhase),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_wrappedPhase),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port1.param = { __xlx_apatb_param_wrappedPhase };
  port1.mname = { "wrappedPhase" };
  port1.nbytes = { 32768 };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_mod_r),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_mod_r),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_mod_r),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_mod_r),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_mod_r),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_mod_r),
#endif
#endif
    .hasWrite = { true },
    .max_nbytes = { 0 },
  };
  port2.param = { __xlx_apatb_param_mod_r };
  port2.mname = { "mod_r" };
  port2.nbytes = { 32768 };
  ...
  try {
    ...
    equalStep_baseline_hw_stub_wrapper(__xlx_apatb_param_imStack, __xlx_apatb_param_wrappedPhase, __xlx_apatb_param_mod_r);
