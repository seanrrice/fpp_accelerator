...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "equalStep_baseline.autotvin.dat"
	set constFileTvOut       "equalStep_baseline.autotvout.dat"
	set constFileHdlTvIn     "equalStep_baseline.autohdltvin.dat"
	set constFileHdlTvOut    "equalStep_baseline.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
