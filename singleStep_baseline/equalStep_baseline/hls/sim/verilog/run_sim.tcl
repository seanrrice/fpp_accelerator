...
if {[file isfile equalStep_baseline.autotvin.dat]} {
	file delete -force equalStep_baseline.autotvin.dat
}

if {[file isfile equalStep_baseline.autotvout.dat]} {
	file delete -force equalStep_baseline.autotvout.dat
}
