...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.equalStep_baseline.autotvin_imStack.dat"
         "c.equalStep_baseline.autotvin_wrappedPhase.dat"
         "c.equalStep_baseline.autotvin_mod_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.equalStep_baseline.autotvout_wrappedPhase.dat"
         "rtl.equalStep_baseline.autotvout_mod_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
