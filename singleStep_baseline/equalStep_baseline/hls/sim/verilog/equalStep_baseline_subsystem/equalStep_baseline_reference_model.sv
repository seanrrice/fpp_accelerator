...
`ifndef EQUALSTEP_BASELINE_REFERENCE_MODEL_SV
`define EQUALSTEP_BASELINE_REFERENCE_MODEL_SV

class equalStep_baseline_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(equalStep_baseline_reference_model)
