...
//
//==============================================================
`ifndef EQUALSTEP_BASELINE_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define EQUALSTEP_BASELINE_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class equalStep_baseline_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "equalStep_baseline_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(equalStep_baseline_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(equalStep_baseline_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(equalStep_baseline_reference_model)::get(p_sequencer,"", "refm", refm))
