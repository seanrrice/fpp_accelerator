...
HLS_SOURCES = ../../../../../test/tb_equalStep.cpp ../../../../../src/equalStep_baseline.cpp
...
$(ObjDir)/tb_equalStep.o: ../../../../../test/tb_equalStep.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../test/tb_equalStep.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_equalStep.d

$(ObjDir)/equalStep_baseline.o: ../../../../../src/equalStep_baseline.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../src/equalStep_baseline.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/equalStep_baseline.d
