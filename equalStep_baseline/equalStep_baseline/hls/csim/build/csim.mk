...
HLS_SOURCES = ../../../../../tb_equalStep.cpp ../../../../../equalStep_baseline.cpp
...
$(ObjDir)/tb_equalStep.o: ../../../../../tb_equalStep.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb_equalStep.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_equalStep.d

$(ObjDir)/equalStep_baseline.o: ../../../../../equalStep_baseline.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../equalStep_baseline.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
